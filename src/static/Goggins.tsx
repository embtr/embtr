            ...
            <ScrollView>
                <View style={{ flex: 1, alignItems: "center" }}>
                    <View style={textViewStyle}>
                        ...
                        <Text>{"\n\n"}</Text>
                        <Text style={textStyle}>This is also an amazing opportunity to raise money for a charity of our choice. We love this part! embtr. has selected our charity to be St. Judes Children's Hospital. Our charity of choice certainly needs no justification. St. Judes will receive 100% of the proceeds from this event. We are offering a few forms of donation (see below).</Text>
                        <Text>{"\n\n"}</Text>
                        ...
                        <Text style={[textStyle, { textAlign: "left" }]}>♥️ Runner - Run with the embtr. team! We ask for a donation of 30$. This donation option includes an embtr. x Goggins 4x4x48 t-shirt. Register Here.{"\n\n"}</Text>
                        <Text style={[textStyle, { textAlign: "left" }]}>♥️ Sponsorship - Individuals may sponsor runners in support of their bold quest to complete the 4x4x48 challenge. Sponsor Here.{"\n\n"}</Text>
                        <Text style={[textStyle, { textAlign: "left" }]}>♥️ General Donation - If you do not have a runner that you'd like to sponsor but still want to donate to the cause - this is the option for you. Donate Here{"\n\n"}</Text>
                        <Text style={textStyle}>{"\n\n"}</Text>
