...
export const ProfileHeader = ({ userProfileModel, onFollowUser, onUnfollowUser, followerCount, followingCount, isFollowingUser, animatedValue }: Props) => {
        ...
        <Animated.View>
            <View>
                ...
                <View style={{ alignItems: 'center', backgroundColor: colors.background }}>
                    ...
                    <Text style={{ fontSize: 12, fontFamily: 'Poppins_500Medium', color: colors.profile_bio_text, paddingTop: 3 }}>
