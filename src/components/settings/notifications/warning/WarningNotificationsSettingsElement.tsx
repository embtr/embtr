...
interface Props {
    title: string;
    description: string;
    option: Constants.WarningNotificationSetting;
    selected: boolean;
    premiumRequired?: boolean;
    userIsPremium?: boolean;
    onPress: (option: Constants.WarningNotificationSetting) => void;
}

export const WarningNotificationsSettingsElement = ({
    title,
    description,
    option,
    selected,
    ...
    const handlePress = () => {
        if (!hasInsufficientPremium) {
            ...
            purchasePremiumWorkflow('Warning Notifications Settings Element');
        }
    };
