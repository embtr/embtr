...
import { TextStyle, Animated, ViewStyle, TextInput, Text, View, InputAccessoryView, Button } from 'react-native';
...
export const DropDownCommentBox = ({ onSubmitText, placeholder, display, displayComment, scrollToEnd }: Props) => {
