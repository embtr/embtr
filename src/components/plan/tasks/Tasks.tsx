        ...
        tasks.length > 0 ?
            ...
            <View style={{ height: "97%", alignItems: "center", justifyContent: "center" }}>
                <Text style={{ color: colors.secondary_text, paddingLeft: 40, paddingRight: 40 }} >
                    You have no tasks. Let's change that! <Text onPress={() => {navigation.navigate("CreateDailyTask")}} style={{ color: colors.tab_selected, fontFamily: "Poppins_400Regular" }} > create a habit</Text>
                </Text>
            </View>
    )
};