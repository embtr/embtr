...
export const PlanningTask = ({ task, locked, isChecked, onCheckboxToggled }: Props) => {
    ...
    return (
        <View>
            <PlannableTask task={task} locked={locked} backgroundColor={backgroundColor} onPress={() => { onCheckboxToggled(task.id, !isChecked) }} />
        </View>
    );
};