...
#
#
read -r versionCodeMajor versionCodeMinor versionCodePatch <<< "$(echo "$currentVersionCode" | sed -E 's/(...)(...)(...)$/\1 \2 \3/')"
versionCodeMajor=$((10#$versionCodeMajor))  # Removes leading zeros
versionCodeMinor=$((10#$versionCodeMinor))  # Removes leading zeros
versionCodePatch=$((10#$versionCodePatch))  # Removes leading zeros
